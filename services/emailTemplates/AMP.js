                  ...
                  <tr>
                    <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                      <div
                        ...
                        We just received your message 🙏 Please review and confirm.
                      </div>
                    </td>
                  </tr>
                  <tr>
                ...
                <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;'
                  ...
                  <tr>
                    <td align='center' style='font-size:0px;padding:10px 25px;padding-top:10px;word-break:break-word;'>
                      <div
                        style="color:#933f24;font-family:'Droid Sans', 'Helvetica Neue', Arial, sans-serif;font-size:18px;line-height:1;text-align:center;">
                        the message was:
                      </div>
                    </td>
                  </tr>
                        ...
                        <tbody>
                          <tr>
                            <td style='width:147px;'>
                              <img alt='Descriptive Alt Text' height='121'
                                src='https://assets.opensourceemails.com/imgs/neopolitan/present.png'
                                style='border:none;display:block;font-size:13px;height:121px;outline:none;text-decoration:none;width:100%;'
                                width='147' />
                            </td>
                          </tr>
                        </tbody>
                  ...
                  <tr>
                    <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                      <div
                        style="color:#933f24;font-family:'Droid Sans', 'Helvetica Neue', Arial, sans-serif;font-size:13px;line-height:1;text-align:center;">
                        Faster download speeds for all users! No wait times Unlimited downloads Premium quality
                      </div>
                    </td>
                  </tr>
                </table>
              ...
              <div class='dys-column-per-100 outlook-group-fix'
                ...
                <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;'
                        ...
                        <tbody>
                          <tr>
                            <td style='width:130px;'>
                              <img alt='Descriptive Alt Text' height='auto'
                  ...
                  <tr>
                    <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                      <div
                        style="color:#933F24;font-family:'Droid Sans', 'Helvetica Neue', Arial, sans-serif;font-size:16px;line-height:20px;text-align:center;">
                        While waiting for an answer, I invite you to take a look at my Linkedin profile. I bet you'll
                        find pretty interesting stories there.
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'
                      ...
                      <table border='0' cellpadding='0' cellspacing='0' role='presentation'
                        style='border-collapse:separate;line-height:100%;width:200px;'>
                        <tr>
                          <td align='center' bgcolor='#AC4D2F' role='presentation'
                            style='background-color:#AC4D2F;border:none;border-radius:4px;cursor:auto;padding:10px 25px;'
                            valign='middle'>
                            <a href='https://example.com'
                              style="background:#AC4D2F;color:#ffffff;font-family:'Droid Sans', 'Helvetica Neue', Arial, sans-serif;font-size:16px;font-weight:bold;line-height:30px;margin:0;text-decoration:none;text-transform:none;"
                              target='_blank'>
                              Let's go!
                            </a>
                          </td>
                  ...
                  <tr>
                    <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                      <table border='0' cellpadding='0' cellspacing='0'
                        style='cellpadding:0;cellspacing:0;color:#000000;font-family:Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:40%;'
                        width='40%'>
                        <tbody>
                          <tr align='center'>
                            <td align='center'>
                              <a href='https://linkedin.com'>
                                <img alt='linkedin' height='50px'
                            ...
                            <td align='center'>
                              <a href='https://twitter.com'>
                                <img alt='twitter' height='50px'
                                  src='https://swu-cs-assets.s3.amazonaws.com/OSET/neopolitan/twitter.png' width='50px'>
                              </a>
                            </td>
                          </tr>
                        </tbody>
              ...
              <div class='dys-column-per-100 outlook-group-fix'
                ...
                <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;'
                  ...
                  <tr>
                    <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                      <div
                        style="color:#BBBBBB;font-family:'Droid Sans', 'Helvetica Neue', Arial, sans-serif;font-size:12px;line-height:1;text-align:center;">
