...
const shadows = {
  ...
  neumorphic: {
    ...
    orange: `5px 5px 15px 0px  ${colors.shadows.dark},
           -4px -3px 4px 0px ${colors.neutrals.lightest}, inset 0px -0.6vw 0px 0px ${colors.accent.lightest}`,
    ...
    orange2: `5px 5px 15px 0px  ${colors.shadows.dark},
           -4px -3px 4px 0px ${colors.neutrals.lightest}, inset 0px -0.8vw 0px 0px ${colors.accent.lightest}`,
    ...
    originalOrange: `0px 2px 5px 0px  ${colors.shadows.dark},
           -4px -3px 4px 0px ${colors.neutrals.lightest}, inset 0px -0.8vw 0px 0px ${colors.accent.lightest}`,
