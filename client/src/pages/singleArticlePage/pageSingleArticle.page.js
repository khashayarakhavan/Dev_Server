...
import PageSingleArticles_Content from './PageSingleArticle.content';

//Code
const EmailMePage = ({ menuOpen, toggleMenuOpen, popUpOpen, togglePopUp, ...props }) => {
  ...
  return (
    <ScreenContainer>
      ...
      <Content open={menuOpen}>
        <PageSingleArticles_Content {...props} />
      </Content>
    </ScreenContainer>
  );
};
